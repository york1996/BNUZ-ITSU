...
<head>
    ...
    <title>管理员管理 - 北京师范大学珠海分校信息技术学院学生会</title>
    <!-- Bootstrap CSS 文件 -->
...
<div class="am-container">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="am-container">
                <form class="am-form-inline" method="post" action="<?php echo U('User/addadmin');?>"  enctype="multipart/form-data">
                    <div class="am-form-group">
                        <label for="username">用户名</label>
                        <input type="text" class="form-control" id="username" placeholder="用户名" name="username">
                    </div>
                    <div class="am-form-group">
                        <label for="nickname">部门名/昵称</label>
    ...
    <div class="table-responsive">
        <table class="table table-hover table-striped">
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td><a href="/index.php/Admin/User/editadmin/uid/<?php echo ($vo["uid"]); ?>">修改</a> <a href="/index.php/Admin/User/deladmin/uid/<?php echo ($vo["uid"]); ?>">删除</a></td>
