...
<head>
    ...
    <title>学时管理 - 北京师范大学珠海分校信息技术学院学生会</title>
    <!-- Bootstrap CSS 文件 -->
...
<div class="am-cf am-padding">
    <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">导入学时</strong> / <small>在这里可以导入学时</small></div>
</div>
<div class="am-container">
<div class="am-panel am-panel-default">
    <div class="am-panel-hd">数据导出Excel</div>
    <div class="am-panel-bd">
        <form action="<?php echo U('Tc/excel_runexport');?>" method="post" enctype="multipart/form-data">
            <div class="am-form-group">
                <div class="am-form-group">
                    <label for="doc-select-1">选择要导出的数据</label>
                    <select name="id" id="doc-select-1">
...
<div class="am-container">
    <a href="/xsh/index.php/Admin/Tc/add" type="button" class="am-btn am-btn-default"><span class="am-icon-plus"></span> 新增</a>
    <table class="table table-hover table-striped">
        ...
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td><a href="/xsh/index.php/Admin/Tc/addtc/id/<?php echo ($vo["id"]); ?>" type="button" class="am-btn am-btn-xs am-btn-default"><span class="am-icon-pencil-square-o"></span> 导入学时</a>
                    <a href="/xsh/index.php/Admin/Tc/del/id/<?php echo ($vo["id"]); ?>" type="button" class="am-btn am-btn-xs am-btn-default"><span class="am-icon-trash-o"></span> 删除</a>
                </td>
...
<!--<div class="am-panel am-panel-default">-->
    <!--<div class="am-panel-hd">Excel备份导入</div>-->
    <!--<div class="am-panel-bd">-->
        <!--<form action="<?php echo U('Tc/excel_runimport1');?>" method="post" enctype="multipart/form-data">-->
            <!--<div class="am-form-group">-->
