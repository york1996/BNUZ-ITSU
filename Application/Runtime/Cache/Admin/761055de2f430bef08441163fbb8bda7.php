...
<head>
    ...
    <title>文章发布 - 北京师范大学珠海分校信息技术学院学生会</title>
    <!-- Bootstrap CSS 文件 -->
...
<div class="am-cf am-padding">
    <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">文章修改</strong> / <small>修改网站已有文章</small></div>
</div>
<hr>

<div class="am-container">
    <form class="am-form" method="post" action="/xsh/index.php/Admin/Article/update" enctype="multipart/form-data">
        <INPUT type="hidden" name="id" value="<?php echo ($vo["id"]); ?>">
        <div class="am-form-group">
            <label>标题:</label>
            <textarea class="am-form-control" rows="1" name="title"><?php echo ($vo["title"]); ?></textarea>
        </div>
        <div class="am-form-group row">
            <div class="col-md-4">
                <label>发布至:</label>
                <select class="form-control" name="classify">
                    <option value="<?php echo ($vo["classify"]); ?>">--不修改类型--</option>
                    <option value="1">综合区</option>
                    <option value="2">品牌活动</option>
                    <option value="3">公示与通知</option>
                    <option value="4">招募公告</option>
            ...
            <div class="col-md-4">
                <label>作者:</label>
                <input type="text" class="form-control" name="writer" placeholder="部门 - 负责人/撰稿人" value="<?php echo ($vo["writer"]); ?>">
            </div>

            <div class="col-md-4">
                <label>修改账号:</label>
                <input type="text" name="name" value="<?php echo ($_SESSION['nickname']); ?>"  disabled>
            </div>
        </div>
        <div class="form-group">
            <script id="container" name="content" type="text/plain"><?php echo (stripslashes(htmlspecialchars_decode($vo["content"]))); ?>
            </script>
        </div>
        <div class="form-group" align="right">
            <button type="submit" name="submit" class="am-btn-primary">发布</button>
        </div>
    </form>
</div>

<script type="text/javascript" src="/xsh/Public/js/jquery-2.0.2.js"></script>
<script type="text/javascript" src="/xsh/Public/ueditor/ueditor.config.js"></script>
<script type="text/javascript" src="/xsh/Public/ueditor/ueditor.all.min.js"></script>
<script>
    $(function(){
