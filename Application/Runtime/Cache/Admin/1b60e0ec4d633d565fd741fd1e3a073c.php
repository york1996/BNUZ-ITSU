...
<div class="am-g">
    <div class="am-u-sm-12">
            <table class="am-table am-table-striped am-table-hover table-main">
                <thead>
                <tr>
                    <th class="table-title">标题</th><th class="table-type">类别</th><th class="table-author am-hide-sm-only">作者</th><th class="table-date am-hide-sm-only">修改日期</th><th class="table-set">操作</th>
                </tr>
                </thead>
                <tbody>
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td>
                        <?php if($vo["classify"] == 1): ?>综合区<?php endif; ?>
                        <?php if($vo["classify"] == 2): ?>品牌活动<?php endif; ?>
                        <?php if($vo["classify"] == 3): ?>公示与通知<?php endif; ?>
                        <?php if($vo["classify"] == 4): ?>招募公告<?php endif; ?>
                        <?php if($vo["classify"] == 5): ?>更多<?php endif; ?>
                    </td>
                    <td class="am-hide-sm-only"><?php echo ($vo["writer"]); ?></td>
                    <td class="am-hide-sm-only"><?php echo (date('Y-m-d',$vo["create_time"])); ?></td>
                    <td>
                        <div class="am-btn-toolbar">
                            <div class="am-btn-group am-btn-group-xs">
                                <a href="/xsh/index.php/Admin/Article/edit/id/<?php echo ($vo["id"]); ?>" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span> 编辑</a>
                                <a href="/xsh/index.php/Admin/Article/del/id/<?php echo ($vo["id"]); ?>" class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"><span class="am-icon-trash-o"></span> 删除</a>
                            </div>
                        </div>
                    </td>
