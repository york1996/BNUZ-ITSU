...
<div class="am-cf am-padding">
    <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">新增学时项目</strong> / <small>在这里可以新增学时项目</small></div>
</div>

<div class="am-container">
    <form class="form-horizontal" method="post" action="/index.php/Admin/Tc/add" enctype="multipart/form-data">
        <div class="am-form-group">
            <label for="title">项目</label>
            <div>
        ...
        <div class="am-form-group">
            <div>
                <button type="submit" class="am-btn-primary">增加</button>
            </div>
        </div>
    </form>
</div>
