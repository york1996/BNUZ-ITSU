...
<div class="am-container">
    <form class="am-form" method="post" action="/index.php/Admin/Tcc/addinfo" enctype="multipart/form-data">
        ...
        <div class="am-form-group">
            <label>学时</label>
            <div>
                <input type="text" class="form-control" name="score" placeholder="学时">
            </div>
        </div>
        <div class="am-form-group">
            <div>
    ...
    <div class="am-panel am-panel-default">
        ...
        <div class="am-panel-bd">
            <form action="<?php echo U('Tcc/excel_runimport');?>" method="post" enctype="multipart/form-data">
                <INPUT type="hidden" name="title" value="<?php echo ($voo["title"]); ?>">
                <INPUT type="hidden" name="classify" value="<?php echo ($voo["id"]); ?>">
                <div class="am-form-group">
    ...
    <table class="am-table am-table-striped am-table-hover table-main am-table-bordered">
        ...
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td><a href="/index.php/Admin/Tcc/delinfo/tid/<?php echo ($vo["tid"]); ?>">删除</a></td>
