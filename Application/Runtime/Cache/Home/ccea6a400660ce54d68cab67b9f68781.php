...
<div class="header">
    <div class="am-g">
        <h1>BNUZ ITSU</h1>
        <p>Information Technology Student Union<br/>Beijing Normal University,Zhuhai<br>登记后若未在个人中心修改,密码默认为教务系统密码</>
        <p><a type="button" class="btn btn-primary btn-sm" href="<?php echo U('Jw/Index');?>">首次登陆点此登记</a></p>
    </div>
    <hr />
</div>
<div class="container">
    <div class="u-lg-6 u-md-8 u-sm-centered container">
        <form class="form-horizontal" action="<?php echo U('Index/login');?>" method="post">
            <div class="form-group">
                <label for="inputEmail3" class="col-sm-2 control-label">学号</label>
                <div class="col-sm-10">
                    <input type="number" class="form-control" name="username" placeholder="请输入你的学号">
                </div>
            </div>
            <div class="form-group">
